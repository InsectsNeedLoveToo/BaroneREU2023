...
DT_Train$Type <- as.factor(DT_Train$Type)
...
norm_param <- preProcess(DT_Train)
train_data <- predict(norm_param, DT_Train)
#test_data <- predict(norm_param, iris_test)

#Creating the tree
model <- rpart(Type ~ ., data = train_data, method = "class",
...
#1) root 12 6 1 (0.5000000 0.5000000)  
#  2) Ephemeroptera< -0.4912881 6 0 1 (1.0000000 0.0000000) *
#  3) Ephemeroptera>=-0.4912881 6 0 2 (0.0000000 1.0000000) *
